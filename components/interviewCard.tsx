...
const InterviewCard = ({ interviewId, userId, role, type, techstack, createdtAt }: InterviewCardProps) => {
    const feedback = null as Feedback | null;
    const normalizedType = /mix/gi.test(type) ? 'Mixed' : 'type'
    const formattedDate = dayjs(feedback?.createdAt || createdtAt || Date.now()).format('YYYY-MM-DD')
    return (
