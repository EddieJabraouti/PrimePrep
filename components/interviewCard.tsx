...
const InterviewCard = ({ id, userId, role, type, techstack, createdAt }: InterviewCardProps) => {
    ...
    const formattedDate = dayjs(feedback?.createdAt || createdAt || Date.now()).format('YYYY, MMMM-DD')
    return (
                ...
                <div>
                    ...
                    <div className="flex flex-row gap-5 mt-3">
                        <div className="flex flex-row gap-2">
                            <Image src="/calender.png" alt="Calender" height={22} width={22} />
                            <p>{formattedDate}</p>
                        </div>
                    ...
                    <p className="line-clamp-2 mt-5">
                        {feedback?.finalAssessment || "You Haven Taken This Interview Yet."}
                    </p>
                </div>
